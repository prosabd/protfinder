...
if (!isset($_SESSION['admin'])) {
    header('Location: /protfinder/login.php');
}
if ($_SESSION['admin'] != 2) {
    header('Location: /protfinder/login.php');
}
...
<body>
    ...
    <?php
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            $ligne = "<a href='/protfinder/admindelete.php?id=" . $id . "'>
            <img src = '/protfinder/img/cross.png' width ='30px'/> </a>";
            //echo "<td>" . "<img src='../ariane/img/cross.png' height=10px>" . "</td>";
            echo "<td>" . $ligne . "</td>";

            $ligneEdit = "<a href='/protfinder/adminedit.php?id=" . $id . "'>
            <img src = '/protfinder/img/edit.png' width ='30px'/> </a>";
